...
/**
 * Title: JwsServiceHello Description: 基于jdk1.6以上的javax.jws 发布webservice接口
 * 
...
public class JwsServiceHello {
	...
	public static void main(String[] args) {
		 ...
		 */
		Endpoint.publish("http://localhost:8080/Service/JwsServiceHello",
				new JwsServiceHello());
		System.out.println("发布成功!");
		// 发布成功后 在浏览器输入 http://localhost:8080/Service/JwsServiceHello?wsdl
	}
}