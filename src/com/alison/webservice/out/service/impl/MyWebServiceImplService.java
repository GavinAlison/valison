    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.webservice.alison.com/", "MyWebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/valison/MyService?wsdl");
    ...
    public MyWebService getMyWebServiceImplPort() {
        return super.getPort(new QName("http://impl.service.webservice.alison.com/", "MyWebServiceImplPort"), MyWebService.class);
    }
    ...
    public MyWebService getMyWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.webservice.alison.com/", "MyWebServiceImplPort"), MyWebService.class, features);
    }
