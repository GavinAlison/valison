...
(
  ...
  cp_id varchar2(1024),
  test_id varchar2(1024)
  
);
create sequence SEQ_caaw_test_cp
start with 1
increment by 1
nominvalue
nomaxvalue
...
/*更新当前库脚本编号*/
 update ws_sys set par_value='185', common_modify_time=to_char(sysdate,'yyyy-MM-dd HH24:mi:ss')
