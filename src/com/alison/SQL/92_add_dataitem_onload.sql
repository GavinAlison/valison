...
alter table ws_dataitem add ONLOAD varchar2(1024);
...
update ws_sys set par_value='92', common_modify_time=to_char(sysdate,'yyyy-MM-dd HH24:mi:ss')  where par_name='DB_VERSION';
