/*﻿子系统MC和文件关系表*/
create table caaw_subsys_mc_file
(
  /*pk*/
  ...
  mc_id varchar2(1024),
  MC varchar2(100),
  file_id varchar2(1024)
);

create sequence SEQ_caaw_subsys_mc_file
start with 1
increment by 1
nominvalue
nomaxvalue
...
/*更新当前库脚本编号*/
 update ws_sys set par_value='181', common_modify_time=to_char(sysdate,'yyyy-MM-dd HH24:mi:ss')
