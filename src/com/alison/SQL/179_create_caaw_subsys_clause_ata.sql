/*﻿子系统条款ATA关系表*/
create table caaw_subsys_clause_ata
(
	/*pk*/
...
create sequence SEQ_caaw_subsys_clause_ata
start with 1
increment by 1
nominvalue
nomaxvalue
...
/*更新当前库脚本编号*/
 update ws_sys set par_value='179', common_modify_time=to_char(sysdate,'yyyy-MM-dd HH24:mi:ss')
